...
const AllLicenses = () => {
    ...
    const fetchDepartments = async () => {
        try {
            ...
            const res = await axios.get('http://localhost:8000/api/v1/users/departments', {
                headers: {
    ...
    const fetchLicenses = async () => {
        try {
            ...
            const response = await axios.get('http://localhost:8000/api/v1/users/licenses/all', {
                headers: {
                    Authorization: `Bearer ${accessToken}`
                },
                withCredentials: true
    ...
    const handleUpdate = async (id) => {
        ...
        try {
            ...
            await axios.put(`http://localhost:8000/api/v1/users/licenses/${id}`, requestData, {
                headers: {
                    Authorization: `Bearer ${accessToken}`
                },
                withCredentials: true
                ...
                <head>
                    ...
                    <script>
                        window.onload = function() {
                            ...
                            fetch(\`http://localhost:8000/api/v1/users/licenses/${licenseId}\`, {
                                headers: {
                                    'Authorization': \`Bearer ${accessToken}\`
                                }
                            })
    ...
    const deleteLicense = async (licenseId) => {
        ...
        try {
            ...
            await axios.delete(`http://localhost:8000/api/v1/users/licenses/${licenseId}`, {
                headers: {
                    Authorization: `Bearer ${accessToken}`
                },
                withCredentials: true
        ...
        <>
            ...
            <div className="min-h-screen bg-gray-50 py-8">
                <div className="max-w-6xl mx-auto px-4">
                    <h2 className="text-2xl font-semibold text-center mb-6">All Licenses</h2>
