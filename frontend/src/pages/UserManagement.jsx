...
const UserManagement = () => {
  ...
  const fetchUsers = async () => {
    ...
    try {
      ...
      const response = await axios.get('http://localhost:8000/api/v1/users/admin/users', {
        headers: {
  ...
  const fetchDepartments = async () => {
    try {
      const accessToken = localStorage.getItem('accessToken');
      const response = await axios.get('http://localhost:8000/api/v1/users/admin/departments', {
        headers: {
          Authorization: `Bearer ${accessToken}`,
        },
        withCredentials: true
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editMode) {
        ...
        await axios.put(`http://localhost:8000/api/v1/users/admin/users/${currentUserId}`, updateData, { 
          headers: {
            Authorization: `Bearer ${accessToken}`,
          },
          withCredentials: true 
  ...
  const handleDelete = async (userId) => {
    ...
    try {
      const accessToken = localStorage.getItem('accessToken');
      await axios.delete(`http://localhost:8000/api/v1/users/admin/users/${userId}`, {
        headers: {
          Authorization: `Bearer ${accessToken}`,
        },
        withCredentials: true
