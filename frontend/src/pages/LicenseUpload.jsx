...
const LicenseUpload = () => {
    ...
    const fetchDepartments = async () => {
        try {
            ...
            // Updated URL to include /users/ prefix to match backend routing
    ...
    const fetchLicenses = async () => {
        try {
            ...
            const res = await axios.get('http://localhost:8000/api/v1/users/licenses/all', {
                headers: {
                    Authorization: `Bearer ${accessToken}`
                },
                withCredentials: true
    ...
    const handleUpload = async (e) => {
        ...
        try {
            ...
            await axios.post('http://localhost:8000/api/v1/users/licenses/upload', requestData, {
                headers: {
                    Authorization: `Bearer ${accessToken}`
                },
                withCredentials: true
