...
const DepartmentForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editMode) {
        ...
        await axios.put(`http://localhost:8000/api/v1/users/admin/departments/${currentDepartmentId}`, 
          {
            name,
            type,
          },
        ...
        // Add new department
        await axios.post("http://localhost:8000/api/v1/users/admin/departments", 
          {
            name,
            type,
          },
  ...
  const handleDelete = async (departmentId) => {
    ...
    try {
      const accessToken = localStorage.getItem('accessToken');
      await axios.delete(`http://localhost:8000/api/v1/users/departments/${departmentId}`, {
        headers: {
          Authorization: `Bearer ${accessToken}`,
        },
        withCredentials: true
